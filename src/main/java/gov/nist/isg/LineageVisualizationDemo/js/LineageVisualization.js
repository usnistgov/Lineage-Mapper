...
function click(d,e) {
    ...
    .dialog({
        ...
        open: function() {
        	var colonyInfo = "";
        	var birthTime = "<p><a href='/deepzoomweb/view/image/replica"+replicaId+"?colony="+d.id+"&frame=" + d.birth +"&layer=replica"+replicaId+"_phase_contrast'>Birth time: " + d.birth +" (Image view)</a></p>";
        	var deathTime = "<p><a href='/deepzoomweb/view/image/replica"+replicaId+"?colony="+d.id+"&frame=" + d.death +"&layer=replica"+replicaId+"_phase_contrast'>Death time: " + d.death +" (Image view)</a></p>";
        	var parentsTable = 
        ...
        title: "<a href='/deepzoomweb/view/data/colony/feature?dataset=replica"+replicaId+"&layer=phase_contrast&colony="+d.id+"&frame="+d.birth+"'>Colony " + d.id+" (Data view)</a>"
    }); 
}
